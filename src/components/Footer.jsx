            ...
            <div className="space-y-3 text-sm text-gray-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="flex flex-wrap items-center gap-x-1">
                  {[settings.phone, settings.phone2].filter(Boolean).map((p, i, arr) => (
                    <React.Fragment key={p}>
                      <a href={`tel:${p.replace(/[^0-9+]/g, "")}`} className="hover:text-[#D9A321] transition-colors">
                        {p}
                      </a>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href={`mailto:${settings.email}`} className="hover:text-[#D9A321] transition-colors">
                  {settings.email}
                </a>
              </div>
            </div>
